...
<head>
    <meta charset="UTF-8">
    <title>Edit Employee Form - Laravel 9 CRUD Tutorial</title>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="salary" class="form-control" placeholder="Enter new employee salary"
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="age" value="{{ $employee->age }}" class="form-control"
                            placeholder="Enter new employee age">
                        @error('age')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="position" value="{{ $employee->positon }}" class="form-control"
                            placeholder="Enter new employee age">
                        @error('position')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="phonenumber" value="{{ $employee->phonenumber }}" class="form-control"
                            placeholder="Enter new employee phone number">
                        @error('phonenumber')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
